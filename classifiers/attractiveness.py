...
def attractiveness(picture_path, engine="haystack"):
    return haystack_attractiveness_demo(picture_path)


def haystack_attractiveness_demo(picture_path):
    url = "https://api.haystack.ai/api/image/analyze?output=json&limit=10000&model=attractiveness&apikey=" + HAYSTACKAI_KEY
