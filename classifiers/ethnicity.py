...
def ethnicity(picture_path, engine="haystack"):
    return haystack_ethnicity_demo(picture_path)


def haystack_ethnicity_demo(picture_path):
    url = "https://api.haystack.ai/api/image/analyze?output=json&limit=10000&model=ethnicity&apikey=" + HAYSTACKAI_KEY
